...
| 1530 | ⭐ [Migration of the Observability Platform Across Azure Landing Zones](#mitra) <br /> 🙂 [ARINDAM MITRA](https://www.linkedin.com/in/arindam-mitra-28981095/) | ⭐ [From Idea to Product: Early Lessons in AI-Powered Project Orchestration on Azure and Microsoft Teams](#abdurixit) <br /> 🙂 [ABDUXUKUR ABDURIXIT](https://www.linkedin.com/in/abdurixit/) <br /> 🙂 [ANDREAS EPPENBERGER](https://www.linkedin.com/in/aeppenberger/) <br /> 🙂 [DANIEL SANER](https://www.linkedin.com/in/danielsaner/) | ⭐ [Managing the Entra Firewall: Conditional Access Policies](#meyer) <br /> 🙂 [FLAVIO MEYER](https://www.linkedin.com/in/flaviomeyer/) <br /> 🙂 [MICHELE BLUM](https://www.linkedin.com/in/micheleblum/) |
...
### <a name="schneider"></a> ⭐️ 10 reasons why companies fail to adopt generative AI
10 reasons why companies fail to adopt Generative AI and what to do about it. Generative AI offers enormous potential to make companies more efficient. Employees become more productive, can take more care of customers and are ultimately happier because they have more meaningful tasks. However, we see that many companies are struggling with the implementation. In this session, we will look for the reasons and discuss strategies to make adoption work.   
🙂 [DAVID SCHNEIDER](https://www.linkedin.com/in/david-schneider/) ⚡️ CTO @ isolutions | Microsoft M365 MVP & Microsoft Regional Director   
...
### <a name="mitra"></a> ⭐️ Migration of the Observability Platform Across Azure Landing Zones
This session explores migrating an Azure Kubernetes–hosted observability platform across Azure landing zones, highlighting key architectural decisions, dependency mapping, and best practices to ensure continuous monitoring, logging, and alerting.

Learn how we migrated an observability platform across Azure landing zones while maintaining visibility and minimizing downtime. The session highlights key design decisions, common pitfalls, and lessons learned from the migration.   
🙂 [ARINDAM MITRA](https://www.linkedin.com/in/arindam-mitra-28981095/) ⚡️ Cloud Solution Architect & Team Lead @ Tata Consultancy Services | Microsoft Azure MVP 
...
🙂 [DANIEL SANER](https://www.linkedin.com/in/danielsaner/) ⚡️ Senior Software Engineer @ Swisscom   

### <a name="meyer"></a> ⭐️ Managing the Entra Firewall: Conditional Access Policies
